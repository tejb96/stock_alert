...
import { TickerTrendsTable } from "@/components/ticker-trends-table";
import { Separator } from "@/components/ui/separator";
import { useDashboardData } from "@/hooks/use-dashboard-data";
import { useTickerTrends } from "@/hooks/use-ticker-trends";
import {
...
export function Dashboard() {
  ...
  const trendsData = useTickerTrends();
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-8 px-4 py-10 sm:px-6">
      ...
      <TickerTrendsTable
        ...
        isLoading={trendsData.status === "loading"}
        error={trendsData.error}
        onRetry={trendsData.refresh}
        lastUpdatedAt={trendsData.lastUpdatedAt}
      />
